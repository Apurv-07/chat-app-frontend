...
const Bell = ({ count, click }) => {
  return (
    ...
    <div className="flex items-center justify-center" onClick={click}>
      <div className="absolute -top-2 -right-3 w-4 bg-red-600 text-white text-[10px] flex items-center justify-center rounded-full z-30">
        <p>{count}</p>
      </div>
      <div className="relative w-[20px] h-[25px] -mt-1.5">
        ...
        <div className="absolute top-[0px] left-1/2 -translate-x-1/2 w-[10px] h-[5px] bg-yellow-600 rounded-t-full"></div>
